              ...
              children: [
                        ...
                        children: [
                          ...
                          ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return Padding(
                                  padding: EdgeInsets.only(
                                      left: ScreenUtils().screenWidth(context) *
                                          0.03,
                                      right: ScreenUtils().screenWidth(context) *
                                          0.03,
                                      bottom: ScreenUtils().screenWidth(context) *
                                          0.03),
                                  child: Bounceable(
                                    onTap: () {
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                        ...
                                        boxShadow: [
                                          BoxShadow(
                                            color:
                                                AppColors.gray7.withOpacity(0.2),
                                            blurRadius: 6,
                                            offset: const Offset(0, 4),
                                          ),
                                        ],
                ...
                Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Text("Course wise collection graph in a day", style: TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.w600,
                            color: AppColors.darkBlue,
                            fontFamily: "Poppins",
                          ...
                          CourseBarChart(courseList: courseList,),
                        ],
                      ),
                    )),
              ],
              ...
              barRods: [
                BarChartRodData(
                  ...
                  gradient:  LinearGradient(
                    colors: [AppColors.alphabetFunContainer, AppColors.rewardBg],
                    ...
                    child: Transform.rotate(
                      ...
                      child: Text(
                          courseList[index].courseName.toString().length>12?
                              courseList[index].courseName.toString().substring(0,12):courseList[index].courseName.toString(),
